...
class _ResultPageState extends State<ResultPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: horoscopedetails == null ? new Center(
        ...
        children: <Widget>[
          new Row(
            ...
            children: <Widget>[
              ...
              new Text(horoscopedetails["sunsign"],style: TextStyle(fontSize: 30,color: Colors.purple[300],fontWeight: FontWeight.bold),),
            ],
          ),
          ...
          new Row(
            ...
            children: <Widget>[
              ...
              new Text(horoscopedetails["date"],style: TextStyle(fontSize: 30,color: Colors.purple[300],fontWeight: FontWeight.bold),),
            ],
          ),
          ...
          new Column(
            ...
            children: <Widget>[
              ...
              new Text(horoscopedetails["horoscope"],style: TextStyle(fontSize: 20,color: Colors.purple[300],fontWeight: FontWeight.bold),textAlign: TextAlign.justify,),
            ],
          ),
          new Padding(padding: const EdgeInsets.only(top: 20)),
          new RaisedButton(
            padding: const EdgeInsets.all(10),
            child : new Text("Go Back",style: TextStyle(fontSize: 25,color: Colors.purple[300],fontWeight: FontWeight.bold),),
            onPressed: (){
